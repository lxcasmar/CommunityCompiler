...
public class KeyStoreGenerator {
    ...
    public static SecretKey recoverKey() {
        ...
        try {
            ...
            KeyStore.SecretKeyEntry keyEntry = (KeyStore.SecretKeyEntry) keystore.getEntry(KEY_ALIAS, protParam);
    ...
    public static void addEntry(String alias, SecretKey key) {
        ...
        char[] KEYSTORE_PASSWORD = sc.nextLine().toCharArray();
        try {
            System.out.println("Create a key password: ");
            char[] KEY_PASSWORD = sc.nextLine().toCharArray();
            KeyStore keystore = KeyStore.getInstance(KEYSTORE_TYPE);
            FileInputStream fis = new FileInputStream(KEYSTORE_FILENAME);
            keystore.load(fis, KEYSTORE_PASSWORD);
    ...
    public static void main(String[] args) {
        ...
        generateKeyStore();
        addEntry(KEY_ALIAS,AES.generateKey(256));
        sc.close();
    }
}
